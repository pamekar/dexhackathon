    ...
    @if(Auth::user()->role_id==3)
        ...
        <script>
            new Chart(document.getElementById("pie-chart"), {
                type:    'pie',
                data:    {
                    labels:   ["Diary", "Grains", "Lifestock", "Vegetables", "Tubers"],
                    datasets: [
                        {
            ...
            new Chart(document.getElementById("doughnut-chart"), {
                type:    'doughnut',
                data:    {
                    labels:   ["Vilnius", "Kaunas", "Palanga", "Telsiai"],
                    datasets: [
                        {
                            label:           "Population (millions)",
                            backgroundColor: ["#3e95cd", "#8e5ea2", "#3cba9f", "#e8c3b9", "#c45850"],
            ...
            new Chart(document.getElementById("line-chart"), {
                ...
                data:    {
                    ...
                    datasets: [
                        {
                            data:        [86, 114, 106, 106, 107, 111, 133, 221, 783, 2478, 1002, 483],
                            label:       "Vilinius",
                            borderColor: "#3e95cd",
                            fill:        false
                        }, {
                    ...
                    gapi.analytics.ready(function () {
                        ...
                        function t(e) {
                            return e.ids || e.viewId ? {
                                ...
                                prop:  "propertyId",
                                value: e.propertyId
                            } : e.accountId ? {prop: "accountId", value: e.accountId} : void 0
                        }
